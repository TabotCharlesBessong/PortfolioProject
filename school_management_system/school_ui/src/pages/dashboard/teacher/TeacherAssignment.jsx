  ...
  const [assignments, setAssignments] = useState([
    {
      ...
      class: "Class A",
      submissions: ["Student A", "Student B"],
      marks: { "Student A": 90, "Student B": 85 },
    },
    {
      id: 2,
      title: "Assignment 2",
      ...
      class: "Class B",
      submissions: ["Student C", "Student D"],
      marks: { "Student C": 80, "Student D": 75 },
    },
  ]);
  ...
  return (
    <AssignmentContainer>
      ...
      <Content>
        ...
        <SetAssignmentButton onClick={handleSetAssignment}>
          Set Assignment
        </SetAssignmentButton>
        <AssignmentList>
          {assignments.map((assignment) => (
            <AssignmentItem key={assignment.id}>
              ...
              <button
                onClick={() =>
                  handleMarkAssignment(assignment.id, "Student A", 95)
                }
              >
                Mark Assignment
              </button>
