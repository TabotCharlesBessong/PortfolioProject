...
const PerformanceSection = () => {
  ...
  const classNames = classPerformances.map(
    (classPerformance) => classPerformance.className
  );
  const averageScores = classPerformances.map(
    (classPerformance) => classPerformance.averageScore
  );
