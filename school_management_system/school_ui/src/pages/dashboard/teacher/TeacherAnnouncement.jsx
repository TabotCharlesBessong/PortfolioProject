  ...
  const [announcements, setAnnouncements] = useState([
    {
      ...
      message: "This is an important announcement from the administration.",
    },
    {
      id: 2,
      title: "Class Announcement",
      message: "Reminder: Tomorrow is the deadline for the assignment.",
    },
  ]);
  ...
  return (
    <AnnouncementContainer>
      ...
      <Content>
        ...
        <AddAnnouncementButton onClick={handleAddAnnouncement}>
          Add Announcement
